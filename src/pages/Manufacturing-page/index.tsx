...
import heroBg from "../../assets/constructioin.jpg";
...
import { Factory, Cog, Settings } from "lucide-react";

const processSteps = [
  {
    title: "Requirement Analysis",
    description:
      "We evaluate production needs, facility requirements, and operational goals.",
  },
  {
    title: "Production Support",
    description:
      "We provide manpower, equipment coordination, and process optimization.",
  },
  {
    title: "Quality & Compliance",
    description:
      "Ensuring safety standards, quality control, and industrial compliance.",
  },
];
    ...
    <div className="font-sans text-gray-800">
      ...
      >
        ...
        <p className="text-gray-200 max-w-2xl text-lg">
          Reliable manufacturing and production support services for industrial zones.
        </p>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-16 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl lg:text-4xl font-semibold text-[#0D3B66] font-spaceGrotesk">
              Powering Industrial Productivity
            </h2>

            <p className="mt-6 text-gray-700 font-manRope leading-relaxed max-w-xl">
              Stedi-City Ltd delivers manufacturing and production support services
              tailored to industrial environments, ensuring efficiency, safety,
              and uninterrupted operations.
            </p>

            <p className="mt-4 text-gray-700 font-manRope leading-relaxed max-w-xl">
              We partner with factories and industrial operators to enhance output,
              maintain facilities, and support production workflows.
            </p>
          </div>
          ...
          <div>
            <img
              ...
              alt="Manufacturing facility operations"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              ...
              >
                <div className="mb-4">
                  {idx % 3 === 0 && <Factory className="w-10 h-10 text-[#0D3B66]" />}
                  {idx % 3 === 1 && <Cog className="w-10 h-10 text-[#0D3B66]" />}
                  {idx % 3 === 2 && <Settings className="w-10 h-10 text-[#0D3B66]" />}
                </div>
